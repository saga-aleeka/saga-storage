...
import type { ContainerType, SampleType } from "./PlasmaContainerList";
...
// Auto-detect container type based on sample type
...
export function CreateContainerDialog({
  ...
  const selectedDims = getGridDimensions(
    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="w-[400px] sm:w-[500px] overflow-y-auto">
        <SheetHeader>
          ...
          <SheetDescription>
            Create a new plasma storage container. Choose the appropriate
            container type based on your sample requirements.
          </SheetDescription>
        </SheetHeader>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Create this container in the archive (for long-term
                      storage)
                    </p>
                  </div>
                  <Switch
              ...
              <div>
                ...
                >
                  <SelectTrigger id="sampleType" aria-label="Sample Type">
            ...
            >
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  <span>Grid Size:</span>
                  <span>
                    {selectedDims.rows}×{selectedDims.cols}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span>Total Capacity:</span>
                  <span>{selectedDims.total} positions</span>
                </div>
                <div className="flex justify-between">
              ...
              <div className="mt-4">
                ...
                <div className="flex flex-col gap-1" style={{ maxWidth: "fit-content" }}>
                  {Array.from(
                    { length: Math.min(selectedDims.rows, 5) },
                    (_, row) => (
                      <div key={row} className="flex gap-1">
                        {Array.from(
                          { length: Math.min(selectedDims.cols, 5) },
                          (_, col) => (
                            <div
                              key={col}
